...
export class AgentLifecycle {
  ...
  async start(): Promise<void> {
    try {
      ...
      throw new AgentError(`Failed to start agent ${this.agentId}`, this.agentId);
    }
  }
  ...
  async stop(): Promise<void> {
    try {
      ...
      throw new AgentError(`Failed to stop agent ${this.agentId}`, this.agentId);
    }
  }
  ...
  async pause(): Promise<void> {
    try {
      ...
      throw new AgentError(`Failed to pause agent ${this.agentId}`, this.agentId);
    }
  }
  ...
  async resume(): Promise<void> {
    try {
      ...
      throw new AgentError(`Failed to resume agent ${this.agentId}`, this.agentId);
    }
  }
